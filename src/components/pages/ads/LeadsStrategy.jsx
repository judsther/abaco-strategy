...
export default function LeadsStrategy() {
  return (
    ...
    <div className="min-h-screen from-black via-zinc-900 to-black px-12 py-14">
      
      {/* Header */}
      <div className="flex justify-between items-start mb-16">
        <div>
          <h1 className="text-4xl font-semibold">OKR Growth Q1 2026</h1>
          <p className="text-zinc-600 mt-1">Aceleración y Expansión</p>
        </div>
      ...
      <section className="mb-20 max-w-4xl">
        <p className="text-xs tracking-widest text-zinc-400 mb-3">MISIÓN CRÍTICA</p>
        <h2 className="text-2xl leading-relaxed text-zinc-700">
          El área de Growth (Comercial, Ventas y Marketing) tiene la misión crítica de validar un modelo de adquisición de clientes que sea escalable, rentable y esté preparado para la expansión.
        </h2>
      </section>
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-3 gap-10 text-sm">
          {[
            ["01", "Escalar la Adquisición", "Superar el ritmo histórico y sentar las bases para los 185 nuevos clientes del año."],
            ["02", "Preparar la Demanda de Capital", "Generar un pipeline de clientes robusto para absorber el nuevo fondo de Accial."],
            ["03", "Expansión Regional", "Validar la operación y la adquisición de clientes en Guatemala."]
          ].map(([id, title, desc]) => (
      ...
      <div className="mb-10 flex justify-between items-center">
        <div>
          ...
          <p className="text-zinc-700 mt-1">Generación de Demanda y Marca Q1 2026</p>
        </div>
