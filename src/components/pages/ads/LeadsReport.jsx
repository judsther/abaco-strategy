  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 space-y-10">
      ...
      <header className="space-y-3">
        <h1 className="text-4xl font-bold text-slate-900">
          Análisis de Rendimiento y Estrategia de Leads Reales
        </h1>
    ...
    <section className="space-y-12">
      ...
      <div className="bg-white border rounded-xl shadow p-8 space-y-6">
        ...
        <p className="text-slate-600">
          Resultados financieros obtenidos tras la validación de calidad de los leads.
        </p>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full border rounded-lg overflow-hidden">
            ...
            <tbody className="text-slate-700">
              <tr>
                <td className="border px-4 py-2 font-medium">Inversión Total</td>
              ...
              <tr>
                <td className="border px-4 py-2 font-medium">Leads Reales Generados</td>
              ...
              <tr>
                ...
                <td className="border px-4 py-2 text-emerald-600 font-semibold">$0.22</td>
                <td className="border px-4 py-2">
          ...
          <table className="min-w-full border rounded-lg overflow-hidden">
            <thead className="bg-slate-100 text-slate-600">
              <tr>
                ...
                <th className="border px-4 py-2 text-left">Enfoque Estratégico</th>
              </tr>
            </thead>
            <tbody className="text-slate-700">
              {[
                [1, 'Adelantamos el pago de facturas', 114, '$0.22', 'Solución directa de flujo de caja'],
                [2, 'Acceso al efectivo', 50, '$0.49', 'Capital para crecimiento empresarial'],
                [3, 'Negocios ágiles = LIQUIDEZ', 28, '$2.14', 'Gestión financiera estratégica'],
                [4, 'Urgencia Liquidez 24h', 28, '$4.88', 'Necesidad de rapidez'],
                [5, 'Plataforma <24h', 9, '$3.83', 'Velocidad de financiamiento'],
                [6, 'Flujo de caja débil', 6, '$9.61', 'Contenido educativo'],
                [7, 'Lista 830 potenciales', 4, '$34.43', 'Rendimiento crítico — pausar'],
                [8, 'Lookalike urgencia', 2, '$20.71', 'Baja conversión'],
              ].map(([pos, name, leads, cpl, focus]) => (
                <tr key={pos}>
                  <td className="border px-4 py-2 text-center font-semibold">{pos}</td>
      ...
      <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-8 space-y-4">
        ...
        <ul className="list-disc pl-6 text-emerald-900 space-y-2">
          <li>
            <strong>Propuesta de valor inmediata:</strong> “Te adelantamos el pago de facturas”
            comunica el beneficio central con máxima claridad.
          </li>
          <li>
            <strong>Claridad B2B:</strong> ataca el dolor principal de las PYMES — la espera por cobrar.
          </li>
          <li>
            <strong>Conexión local:</strong> uso de hashtags como <code>#pymes</code> y
            <code> #elsalvador</code> refuerza relevancia geográfica y demográfica.
          </li>
        </ul>
      </div>
