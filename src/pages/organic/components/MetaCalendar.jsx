    ...
    <div>
      ...
      <WeekBlock title="Facebook / Instagram - Mes 1 Q1">
        <CalendarItem
          ...
          format="Reel (15-30s)"
          contenido1={`¿Vender al crédito te quita el sueño? 
            Aquí tienes 3 razones para que dejes de temerle y empieces a usarlo a tu favor. 
            
            1. Vende sin límites: No le temas a los plazos de 30, 60 o 90 días de tus clientes corporativos. Vender al crédito no es 'perder dinero de vista', es abrir la puerta a contratos más grandes y mejores clientes. 
            
            2. Activa tu flujo recurrente: No esperes sentado a que venza el plazo. Convierte esas facturas en efectivo hoy mismo con Ábaco. Así, transformas una cuenta por cobrar en capital de trabajo que ya está en tu cuenta. 
            
            3. Multiplica tu capacidad: Usa ese capital inmediato para financiar tu siguiente gran venta. Mientras tu competencia espera a cobrar, tú ya estás entregando el siguiente pedido.
...
`}
          postId1="fb-ig-mes1-martes-carrousel-1"
          contenido2={`
          ...
          caption2={`
            ...
            `}
          postId2="fb-ig-mes1-martes-carrousel-2"
          ...
          postId3="fb-ig-mes1-martes-carrousel-3"
          ...
          postId4="fb-ig-mes1-martes-carrousel-4"
...
El video comienza con un ábaco antiguo de madera y cuentas de piedra flotando en un fondo blanco limpio. El objeto comienza a transformarse fluidamente: las cuentas de piedra se convierten en los engranajes de una Pascalina (calculadora mecánica de metal), esta se compacta hasta transformarse en una calculadora de bolsillo gris de los años 80, y finalmente, el dispositivo se desvanece y simplifica hasta convertirse en una interfaz digital minimalista dentro de un smartphone, donde se ve el logo de Ábaco y un saldo que crece rápidamente.`}
          ...
          postId1="fb-ig-mes1-jueves-curioso-1"
          contenido2={`
          ...
          postId2="fb-ig-mes1-jueves-curioso-2"
      ...
      ¡No esperes 30 o 60 días para ver tu capital!`}
          postId3="fb-ig-mes1-jueves-curioso-3"
...
Voz en off acompañado de texto: ¿Sabías que en El Salvador la gente cortaba el dinero para poder pagar? \n\nA finales del siglo XIX, la falta de monedas pequeñas era tan grave que los salvadoreños partían los billetes de 1 Peso a la mitad para crear "cambio" de 50 centavos. Era una medida desesperada para no detener el comercio por falta de liquidez.`}
          ...
          postId4="fb-ig-mes1-jueves-curioso-4"
       
       />
            <CalendarItem
          day="Viernes de Static"
          time="IG / FB: 8 PM "
          platform="Instagram / Facebook"
          pillar="Comercial/Oferta Directa"
          format="Single Image"
          contenido1={`¿Tu efectivo está atrapado en una factura? Libera tu liquidez hoy con CashX.

            `}
          caption1={`No dejés que las cuentas por cobrar frenen el crecimiento de tu empresa. Con el financiamiento de facturas digital de Ábaco, conviertes tus facturas en efectivo inmediato para reinvertir donde más lo necesitas. 

            Solicita tu adelanto hoy en el link de la bio.
            `}
          postId1="fb-ig-mes1-viernes-static-1"
          contenido2={`Olvídate de los trámites lentos. Adelanta tus facturas 100% digital.
            
            `}
          caption2={`En el mundo de los negocios, el tiempo es dinero. En Ábaco te ofrecemos una plataforma ágil, sin papeleo excesivo y con desembolsos rápidos. Toma el control de tu flujo de caja con CashX.

            Regístrate gratis en abacocapital.co`}
          postId2="fb-ig-mes1-viernes-static-2"
          contenido3={`Optimizá tu flujo de caja y beneficiá a tu cadena de suministro.
            
            `}
          caption3={`Con ProntoCash, ofreces a tus proveedores la opción de cobrar antes sin afectar tu capital operativo. Una solución ganar-ganar para el ecosistema empresarial salvadoreño.
            `}
          postId3="fb-ig-mes1-viernes-static-3"
          contenido4={`Obtén mejores condiciones con tus proveedores pagando con ProntoCash. 

            `}
          caption4={`El pronto pago te da una posición privilegiada para negociar mejores precios y servicios. Ábaco facilita la logística financiera para que tu solo te preocupes por crecer.
             Más información en el link de nuestra bio.`}
          postId4="fb-ig-mes1-viernes-statics-4"
        />
      </WeekBlock>
    </div>
  );
